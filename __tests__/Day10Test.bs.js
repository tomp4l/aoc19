...
Jest.describe("loading", (function (param) {
        ...
        Jest.test("load an asteroid", (function (param) {
                return Jest.Expect.toBe(/* Asteroid */0, Jest.Expect.expect(Day10$Aoc19.Space.get(/* tuple */[
                                      1,
                                      0
                                    ])(Day10$Aoc19.Space.fromString(input))));
              }));
        Jest.test("load empty space", (function (param) {
                return Jest.Expect.toBe(/* EmptySpace */1, Jest.Expect.expect(Day10$Aoc19.Space.get(/* tuple */[
                                      0,
                                      1
                                    ])(Day10$Aoc19.Space.fromString(input))));
              }));
        Jest.test("return out of bounds", (function (param) {
                return Jest.Expect.toBe(/* OutOfBounds */2, Jest.Expect.expect(Day10$Aoc19.Space.get(/* tuple */[
                                      0,
                                      3
                                    ])(Day10$Aoc19.Space.fromString(input))));
              }));
...
Jest.describe("gcm", (function (param) {
        Jest.test("of 1,1 is 1", (function (param) {
                return Jest.Expect.toBe(1, Jest.Expect.expect(Day10$Aoc19.gcm(/* tuple */[
                                    1,
                                    1
                                  ])));
              }));
        ...
        Jest.test("of 4,0 is 4", (function (param) {
                return Jest.Expect.toBe(4, Jest.Expect.expect(Day10$Aoc19.gcm(/* tuple */[
                                    4,
                                    0
                                  ])));
              }));
        ...
        Jest.test("of 2,4 is 2", (function (param) {
                return Jest.Expect.toBe(2, Jest.Expect.expect(Day10$Aoc19.gcm(/* tuple */[
                                    2,
                                    4
                                  ])));
              }));
        ...
        Jest.test("of 5,5 is 5", (function (param) {
                return Jest.Expect.toBe(5, Jest.Expect.expect(Day10$Aoc19.gcm(/* tuple */[
                                    5,
                                    5
                                  ])));
              }));
...
Jest.describe("space", (function (param) {
        ...
        Jest.test("can find a visible", (function (param) {
                return Jest.Expect.toBe(true, Jest.Expect.expect(Day10$Aoc19.isVisible(/* tuple */[
                                    4,
                                    0
                                  ], space, /* tuple */[
                                    1,
        ...
        Jest.test("can find a blocked", (function (param) {
                return Jest.Expect.toBe(false, Jest.Expect.expect(Day10$Aoc19.isVisible(/* tuple */[
                                    2,
                                    2
                                  ], space, /* tuple */[
                                    0,
        ...
        Jest.test("can count visible", (function (param) {
                return Jest.Expect.toBe(8, Jest.Expect.expect(Day10$Aoc19.visibleCount(space, /* tuple */[
                                    3,
                                    4
                                  ])));
              }));
        ...
        Jest.test("first target", (function (param) {
                return Jest.Expect.toEqual(/* tuple */[
                            1,
                            0
                          ], Jest.Expect.expect(Day10$Aoc19.findFirstTarget(/* tuple */[
                                    0,
                                    2
                                  ], space)));
              }));
...
Jest.describe("vectors", (function (param) {
        Jest.test("vector length can be calculated", (function (param) {
                return Jest.Expect.toEqual(5, Jest.Expect.expect(Day10$Aoc19.vectorLength(/* tuple */[
                                    3,
                                    4
                                  ])));
              }));
        Jest.test("0 angle can be calculated", (function (param) {
                return Jest.Expect.toEqual(0, Jest.Expect.expect(Day10$Aoc19.angle(/* tuple */[
                                    0,
                                    1
                                  ], /* tuple */[
                                    0,
        ...
        Jest.test("1/4 angle can be calculated", (function (param) {
                return Jest.Expect.toBeCloseTo(1.57, Jest.Expect.expect(Day10$Aoc19.angle(/* tuple */[
                                    0,
                                    -1
                                  ], /* tuple */[
                                    1,
        ...
        Jest.test("angle", (function (param) {
                return Jest.Expect.toBeCloseTo(0.46, Jest.Expect.expect(Day10$Aoc19.angle(/* tuple */[
                                    0,
                                    -1
                                  ], /* tuple */[
                                    1,
...
Jest.describe("laser", (function (param) {
        ...
        Jest.test("first target aquired", (function (param) {
                return Jest.Expect.toEqual(/* tuple */[
                            8,
                            1
                          ], Jest.Expect.expect(Day10$Aoc19.bigFuckingLaser(/* tuple */[
                                    8,
                                    3
                                  ], space, 1)));
              }));
